$(document).ready((function() {
        $(".agenda-comparison-table tr:nth-child(2) .wrapper2, .agenda-comparison-table tr:nth-child(4) .wrapper2, .agenda-comparison-table tr:nth-child(13) .wrapper2, .agenda-comparison-table tr:nth-child(14) .wrapper2").attr("colspan", 3)
    })), $(document).ready((function() {
        $(".agenda-comparison-table tr:nth-child(8) .wrapper2").attr("colspan", 2)
    })),
    function(t, e) {
            ...
            c = {
                ...
                load: function(t) {
                    ...
                    if (t.getAttribute("data-src") && (t.src = t.getAttribute("data-src")), t.getAttribute("data-srcset") && t.setAttribute("srcset", t.getAttribute("data-srcset")), t.getAttribute("data-background-image")) t.style.backgroundImage = "url('" + t.getAttribute("data-background-image").split(",").join("'),url('") + "')";
                        ...
                        n = -1 === xOf("url(") ? "url(" + n + ")" : n, 1 === i.length ? t.style.backgroundImage = n : t.setAttribute("style", (t.getAttribute("style") || "") + "background-image: " + n + "; background-image: -webkit-image-set(" + i + "); background-image: image-set(" + i + ")")
                    }
...
observer.observe(), $(document).ready((function() {
        $("table:not(.comparison_table)").wrap("<div style='overflow-x:auto;'></div>").css({
            "table-layout": "fixed",
            "white-space": "nowrap",
            "max-width": "none",
            width: "auto",
        ...
        $(this).parent().parent().fadeOut(), $("body").attr("style", (function(i, s) {
            return (s || "") + "margin-top: 70px;"
        })), $("body").addClass("close_bnr"), $("#menu").attr("style", (function(i, s) {
            return (s || "") + "top: 0 !important;"
        }))
    })), $("[id*='-tabImg']").click((function(e) {
        var id = $(this).data("id"),
            section = $(this).data("section");
        $(".desktopTabResource" + section).children().hide(), $("#desktopTabResource" + section + "-" + id).fadeIn()
    })), $(".code-toggle").on("click", (function(e) {
        $(this).parent().children().removeClass("active"), $(this).addClass("active");
        var $target = $(this).data("target");
        $($target).parent().children(".console").hide(), $($target).fadeIn()
    })), $(".btn_slider").on("click", (function(e) {
        $(this).parent().parent().find(".btn_slider").removeClass("active"), $(this).addClass("active");
        var container = $(this).data("container"),
            target = $(this).data("target");
        $(container).children().hide(), $(target).fadeIn().slick("setPosition")
    })), $(".show-more-code__cta").on("click", (function() {
        var $btn = $(this),
            $codeWrapper = $(this).next().next(),
            codeWrapperMaxHeight = $codeWrapper.data("maxheight");
        "none" == $codeWrapper.css("max-height") || void 0 === $codeWrapper.css("max-height") ? ($codeWrapper.css({
            "max-height": codeWrapperMaxHeight
        }), $codeWrapper.animate({
            scrollTop: 0
        }, "fast"), $codeWrapper[0].scrollIntoView(), $btn.text("Show more")) : ($codeWrapper.css({
            "max-height": "initial"
        }), $btn.text("Show less"))
    })),
    function(t) {
        ...
        var e = -1,
            ...
            a = function(e) {
                ...
                return a.each((function() {
                    ...
                    null === s ? r.push(e) : Math.floor(Math.abs(i - a)) <= 1 ? r[r.length - 1] = s.add(e) : r.push(e), i = a
                })), r
            },
            i = function(e) {
                var o = {
            ...
            r = t.fn.matchHeight = function(e) {
                ...
                return this.length <= 1 && !o.target || (r._groups.push({
                    elements: this,
                    options: o
        ...
        $(".card.card--icon > div > h3, .wrapper_testimonials > div > h3, .wrapper_metrics h3").matchHeight()
    })),
    function(factory) {
        "use strict";
...
if ("instantIntensity" in document.body.dataset) {
    ...
    if ("mousedown" == _t.substr(0, 9)) u = !0, "mousedown-only" == _t && (f = !0);
    else if ("viewport" == _t.substr(0, 8)) navigator.connection && (navigator.connection.saveData || navigator.connection.effectiveType && navigator.connection.effectiveType.includes("2g")) || ("viewport" == _t ? document.documentElement.clientWidth * document.documentElement.clientHeight < 45e4 && (m = !0) : "viewport-all" == _t && (m = !0));
    else {
        var _e = parseInt(_t);
        isNaN(_e) || (l = _e)
    }
...
if (i) {
    ...
    if (f || document.addEventListener("touchstart", (function(t) {
            ...
            if (!(performance.now() - e < d)) {
                ...
                h(o) && (o.addEventListener("mouseout", p, {
                    passive: !0
            ...
            if (!(performance.now() - e < d)) {
                var n = t.target.closest("a");
                if (!(t.which > 1 || t.metaKey || t.ctrlKey) && n) {
        ...
        }), _n), m)(_t2 = window.requestIdleCallback ? function(t) {
...
$(document).ready((function() {
    var currentPage = 2,
        blogOutOfPosts = !1,
        fetching = !1;
    if ($(".post-listing")[0]) var postContainer = $(".post-listing");
    $(window).scroll((function() {
        if (!blogOutOfPosts && !fetching) {
            var windowScroll = $(this).scrollTop(),
                windowHeight = $(this).height();
            if ($(".post-listing")[0])
                if (windowScroll + windowHeight >= postContainer.offset().top + postContainer.height()) {
                    fetching = !0;
                    var ajaxUrl = "https://www.clarifai.com/blog/page/" + currentPage;
                    $.get(ajaxUrl, (function(data) {
                        var posts = $(data).find(".post-item");
                        0 != posts.length ? (posts.each((function() {
                            var blogPost = $(this);
                            postContainer.append(blogPost)
                        })), setTimeout((function() {
                            currentPage += 1, fetching = !1
...
//# sourceURL=https://cdn2.hubspot.net/hub/4505120/hub_generated/template_assets/32403573546/1726073682351/Templates/Assets/JS/main-v2.js